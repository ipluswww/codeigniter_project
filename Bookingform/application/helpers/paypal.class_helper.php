<?php
	...
	class MyPayPal {
		...
		private function send_mail()
		{
			...
			$to      = 'tony_love_plus@protonmail.com';
			...
			";
			$headers = 'From: bookings@shelbyssidcartours.com' . "\r\n" .
		...
		function DoExpressCheckoutPayment(){
			...
			if(!empty(_SESSION('ppl_products'))&&!empty(_SESSION('ppl_charges'))){
				...
				if("SUCCESS" == strtoupper($httpParsedResponseAr["ACK"]) || "SUCCESSWITHWARNING" == strtoupper($httpParsedResponseAr["ACK"])){
					...
					//echo '<h2>Successed</h2>';
					//echo 'Your Transaction ID : '.$httpParsedResponseAr["PAYMENTINFO_0_TRANSACTIONID"];
