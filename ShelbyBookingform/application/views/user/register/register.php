...
<html>
    ...
    <body>
        <div id="main" class="LuloCleanOutline page3-style">
            <form action="<?php echo base_url();?>register" id="booking_form" method="post">
                ...
                <div class="body" style="max-width: 650px; margin: 0 auto;">
					...
					<div class="row form-row">
						...
						<div class="col-sm-6">
							<div class="input-box-container">
								<h3 class="LuloCleanOne-Bold">Confirm Password<span class='required'>*</span></h3>
								<input type="password" name="password_confirm" class="require LuloCleanOne full-width" />
							</div>
						</div>
					</div>
                ...
                <div class="footer">
                    <button style="padding: 10px 70px !important;" class="btn-submit LuloCleanOne-Bold" type="submit">Register</button>
                </div>
            </form>
        </div>
