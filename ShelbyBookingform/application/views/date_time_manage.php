...
<html>
    ...
    <body>
        <div id="main" class="LuloCleanOutline date_time_manage-style">
            <form action="<?php echo base_url();?>booking_choosedatetime" id="booking_form" method="post">
                ...
                <div class="header">
                    ...
                    <h2 class="LuloCleanOne-Bold header-text tour-title-text"><?php echo $title; ?></h2>
					<a class="LuloCleanOne-Bold" style="position: absolute; right: 20px; top: 13px; color: #08c; font-size: 10px;" href="<?php echo base_url();?>logout">LogOut</a>
                </div>

                <div class="body">
                    <div class="top-space input-box-container">
                        <h3 class="LuloCleanOne-Bold">Edit YOUR DATE</h3>
                        <div class="date-container LuloCleanOne">
                            ...
                            <div class="datesofweek">
                                ...
                                <div class="disabled day-item day-sunday">
                    ...
                    <div class="select-time-container">
                        <h3 class="LuloCleanOne-Bold">Edit YOUR TIME</h3>
                ...
                <div class="footer">
                    <a class="LuloCleanOne-Bold btn-return" href="<?php echo base_url();?>booking_choosedatetime">Return</a>
                </div>
            </form>
        </div>
        ...
        <script src="<?php echo asset_url();?>js/datetime_manage.js"></script>
